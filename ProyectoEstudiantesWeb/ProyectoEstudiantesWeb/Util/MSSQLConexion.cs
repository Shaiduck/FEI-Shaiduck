...
namespace ProyEstudiantesWeb.Util
{
    public class MSSQLConexion:Conexion
    {
        ...
        private string CadenaConexion()
        {
            ...
            string str = @"Data Source=YUKI\SHAIDUCK;Initial Catalog=Estudiantes;Integrated Security=True;User ID=Shaiduck;Password=HanekawaTsubasa9@@~";
            try
            {
